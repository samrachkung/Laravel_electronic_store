        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0">
                <div class="card-body text-center py-5">
                    ...
                    <h2 class="text-warning mb-3">Payment QR Code Expired</h2>
                    <p class="text-muted mb-4">Your payment QR code has expired. Please retry your order.</p>
                    ...
                    <div class="d-flex gap-3 justify-content-center">
                        <a href="{{ route('frontend.checkout.index') }}" class="btn btn-primary">
                            <i class="bi bi-arrow-clockwise me-2"></i>Retry Checkout
                        </a>
